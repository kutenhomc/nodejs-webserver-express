...
function (_Scope) {
  ...
  function FlowScope() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FlowScope)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this2.declareFunctions = [];
    return _this2;
  }
...
var flow = function flow(superClass) {
  ...
  function (_superClass2) {
    ...
    function _temp() {
      ...
      _this3 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(_temp)).call.apply(_getPrototypeOf3, [this].concat(args)));
...
function (_Scope2) {
  ...
  function TypeScriptScope() {
    ...
    _this16 = _possibleConstructorReturn(this, (_getPrototypeOf4 = _getPrototypeOf(TypeScriptScope)).call.apply(_getPrototypeOf4, [this].concat(args)));
    _this16.types = [];
    _this16.enums = [];
    _this16.constEnums = [];
    _this16.classes = [];
      ...
      _createClass(_class3, [{
          ...
          return this.tsInType(function () {
            ...
            if (asserts && _this21.match(types._this)) {
              ...
              if (thisTypePredicate.type === "TSThisType") {
                ...
                node.asserts = true;
                thisTypePredicate = _this21.finishNode(node, "TSTypePredicate");
              } else {
                _this21.resetStartLocationFromNode(thisTypePredicate, node);
            ...
            if (!typePredicateVariable) {
              ...
              node.parameterName = _this21.parseIdentifier();
        ...
        value: function tsParseTypeAliasDeclaration(node) {
          ...
          node.typeAnnotation = this.tsInType(function () {
            ...
            if (_this23.isContextual("intrinsic") && _this23.lookahead().type !== types.dot) {
              var _node8 = _this23.startNode();

              _this23.next();

              return _this23.finishNode(_node8, "TSIntrinsicKeyword");
            }
        ...
        value: function parseClass(node) {
          ...
          try {
            ...
            return (_get13 = _get(_getPrototypeOf(_class3.prototype), "parseClass", this)).call.apply(_get13, [this, node].concat(args));
          } finally {
...
function (_ParserError) {
  ...
  function Tokenizer(options, input) {
    ...
    _this38 = _possibleConstructorReturn(this, _getPrototypeOf(Tokenizer).call(this));
    ...
    value: function setStrict(strict) {
      ...
      if (strict) {
        this.state.strictErrors.forEach(function (message, pos) {
          return _this39.raise(pos, message);
        });
...
function (_ExpressionScope) {
  ...
  function ArrowHeadParsingScope(type) {
    ...
    _this41 = _possibleConstructorReturn(this, _getPrototypeOf(ArrowHeadParsingScope).call(this, type));
...
function (_LValParser) {
  ...
  _createClass(ExpressionParser, [{
    ...
    value: function parseExpression(disallowIn, refExpressionErrors) {
      ...
      if (disallowIn) {
        return this.disallowInAnd(function () {
          return _this43.parseExpressionBase(refExpressionErrors);
        });
      }
    ...
    value: function parseMaybeAssignAllowIn(refExpressionErrors, afterLeftParse, refNeedsArrowPos) {
      ...
      return this.allowInAnd(function () {
        return _this45.parseMaybeAssign(refExpressionErrors, afterLeftParse, refNeedsArrowPos);
      });
    }
  }, {
    key: "parseMaybeAssign",
          ...
          switch (this.getPluginOption("pipelineOperator", "proposal")) {
            case "smart":
              return this.withTopicPermittingContext(function () {
                return _this46.parseSmartPipelineBody(_this46.parseExprOpBaseRightExpr(op, prec), startPos, startLoc);
              });

            case "fsharp":
              return this.withSoloAwaitPermittingContext(function () {
                return _this46.parseFSharpPipelineBody(prec);
              });
          }
    ...
    value: function parseFunctionBody(node, allowExpression) {
      ...
      if (isExpression) {
        ...
        node.body = this.parseBlock(true, false, function (hasStrictModeDirective) {
          var nonSimple = !_this47.isSimpleParamList(node.params);

          if (hasStrictModeDirective && nonSimple) {
            var errorPos = (node.kind === "method" || node.kind === "constructor") && !!node.key ? node.key.end : node.start;

            _this47.raise(errorPos, ErrorMessages.IllegalLanguageModeDirective);
          }

          var strictModeChanged = !oldStrict && _this47.state.strict;

          _this47.checkParams(node, !_this47.state.strict && !allowExpression && !isMethod && !nonSimple, allowExpression, strictModeChanged);

          if (_this47.state.strict && node.id) {
            _this47.checkLVal(node.id, "function name", BIND_OUTSIDE, undefined, undefined, strictModeChanged);
          }
        });
        this.prodParam.exit();
        this.expressionScope.exit();
  ...
  _createClass(StatementParser, [{
    ...
    value: function parseDoStatement(node) {
      ...
      node.body = this.withTopicForbiddingContext(function () {
        return _this48.parseStatement("do");
      });
    ...
    value: function parseTryStatement(node) {
      ...
      if (this.match(types._catch)) {
        ...
        clause.body = this.withTopicForbiddingContext(function () {
          return _this49.parseBlock(false, false);
        });
        this.scope.exit();
    ...
    value: function parseWhileStatement(node) {
      ...
      this.state.labels.push(loopLabel);
      node.body = this.withTopicForbiddingContext(function () {
        return _this50.parseStatement("while");
      });
      this.state.labels.pop();
    ...
    value: function parseWithStatement(node) {
      ...
      node.body = this.withTopicForbiddingContext(function () {
        return _this51.parseStatement("with");
      });
    ...
    value: function parseForIn(node, init, awaitAt) {
      ...
      this.expect(types.parenR);
      node.body = this.withTopicForbiddingContext(function () {
        return _this53.parseStatement("for");
      });
      this.scope.exit();
      this.state.labels.pop();
    ...
    value: function parseFunction(node) {
      ...
      this.withTopicForbiddingContext(function () {
        _this54.parseFunctionBodyAndFinish(node, isStatement ? "FunctionDeclaration" : "FunctionExpression");
      });
      this.prodParam.exit();
      this.scope.exit();
    ...
    value: function parseClassBody(constructorAllowsSuper, oldStrict) {
      ...
      this.expect(types.braceL);
      this.withTopicForbiddingContext(function () {
        while (!_this55.match(types.braceR)) {
          if (_this55.eat(types.semi)) {
            if (decorators.length > 0) {
              throw _this55.raise(_this55.state.lastTokEnd, ErrorMessages.DecoratorSemicolon);
            }

            continue;
          }

          if (_this55.match(types.at)) {
            decorators.push(_this55.parseDecorator());
            continue;
          }

          var member = _this55.startNode();

          if (decorators.length) {
            member.decorators = decorators;

            _this55.resetStartLocationFromNode(member, decorators[0]);

            decorators = [];
          }

          _this55.parseClassMember(classBody, member, state);

          if (member.kind === "constructor" && member.decorators && member.decorators.length > 0) {
            _this55.raise(member.start, ErrorMessages.DecoratorConstructor);
          }
        }
      });
...
function (_StatementParser) {
  ...
  function Parser(options, input) {
    ...
    _this56 = _possibleConstructorReturn(this, _getPrototypeOf(Parser).call(this, options, input));

    var ScopeHandler = _this56.getScopeHandler();

    _this56.options = options;
    _this56.inModule = _this56.options.sourceType === "module";
    _this56.scope = new ScopeHandler(_this56.raise.bind(_assertThisInitialized(_this56)), _this56.inModule);
    _this56.prodParam = new ProductionParameterHandler();
    _this56.classScope = new ClassScopeHandler(_this56.raise.bind(_assertThisInitialized(_this56)));
    _this56.expressionScope = new ExpressionScopeHandler(_this56.raise.bind(_assertThisInitialized(_this56)));
    _this56.plugins = pluginsMap(_this56.options.plugins);
    _this56.filename = options.sourceFilename;
    return _this56;
  }
