...
var writeFile = fs.writeFileSync; // Same code as in FileAsync, minus `await`
  ...
  _createClass(FileSync, [{
    ...
    value: function read() {
      ...
      if (fs.existsSync(this.source)) {
        // Read database
        try {
          var data = readFile(this.source, 'utf-8').trim(); // Handle blank file

          return data ? this.deserialize(data) : this.defaultValue;
        } catch (e) {
          if (e instanceof SyntaxError) {
            e.message = "Malformed JSON in file: ".concat(this.source, "\n").concat(e.message);
          }
