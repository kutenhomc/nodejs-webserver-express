  ...
  fieldNames.forEach(function (fieldName) {
    ...
    if (builderNames.includes(fieldName)) {
      if (areAllRemainingFieldsNullable(fieldName, builderNames, fields)) {
        args.push("".concat(_index["default"].toBindingIdentifierName(fieldName)).concat(isNullable(field) ? "?:" : ":", " ").concat(typeAnnotation));
      } else {
        args.push("".concat(_index["default"].toBindingIdentifierName(fieldName), ": ").concat(typeAnnotation).concat(isNullable(field) ? " | undefined" : ""));
      }
    }
...
try {
  for (var _iterator = _index["default"].TYPES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    var result = _index["default"].NODE_FIELDS[realName] || _index["default"].FLIPPED_ALIAS_KEYS[realName] ? "node is ".concat(realName) : "boolean";
...
for (var _type in _index["default"].DEPRECATED_KEYS) {
  code += "/**\n * @deprecated Use `".concat(_index["default"].DEPRECATED_KEYS[_type], "`\n */\nexport type ").concat(_type, " = ").concat(_index["default"].DEPRECATED_KEYS[_type], ";\n\n");
}
